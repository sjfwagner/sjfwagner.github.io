...
The numbers for men go down again, to roughtly 4.4 for male podcasts per month and 1.6 female podcasts per month when evaluately tightly. Perhaps the strongest argument for the "we need more male episodes" argument comes from this -- when evaluated tightly men's episodes go down far more than female episodes. I expect that they have a tendency to view male-oriented episodes as neutral rather than male. As a woman living in a 'male-default' world, this is baffling.
